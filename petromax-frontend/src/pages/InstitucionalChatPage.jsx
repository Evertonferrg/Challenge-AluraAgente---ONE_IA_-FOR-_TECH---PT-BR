...
const API_URL = import.meta.env.VITE_API_URL_INSTITUCIONAL || 'http://127.0.0.1:8000/perguntar-institucional';

const gerarSessionId = () => 'sess_inst_' + Math.random().toString(36).slice(2, 11);

const InstitucionalChatPage = () => {
    const [sessionId] = useState(gerarSessionId);
    const [mensagens, setMensagens] = useState([
        { autor: 'ai', texto: 'Olá! Posso te ajudar com dúvidas sobre nossos produtos, entregas, FISPQ e certificações. Como posso ajudar?' }
    ]);
        ...
        <div className="page-container">
            <main className="main-content">
                <div className="chat-container">
                    <h1 className="chat-title">Assistente Institucional PetroMax</h1>
                    <p className="chat-subtitle">Produtos, entregas, FISPQ e certificações.</p>
...
export default InstitucionalChatPage;